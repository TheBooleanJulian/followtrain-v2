-- FollowTrain Supabase Schema - Security Enhanced Version
...
CREATE POLICY "Allow train creation" ON public.trains
...
CREATE POLICY "Allow joining trains" ON public.participants
